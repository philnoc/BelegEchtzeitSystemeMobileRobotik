...
class Routine(Node):
    def __init__(self):
        ...
        self.declare_parameter('image_path', 'snapshot.png')
        ...
        self.declare_parameter('backup_time', 2.0)          # s backward after hazard
        self.declare_parameter('max_forward_time', 30.0)    # s safety cap while searching
        self.declare_parameter('return_time_offset_s', 1.5) # s kürzer auf dem Rückweg
    ...
    def switch(self, new_phase: Phase):
        ...
        if new_phase == Phase.DRIVE_TILL_HAZARD:
            ...
            # Rückweg: etwas kürzer als Hinweg
    ...
    def play_mario(self):
        ...
        REST = 0
        Mariomelody = [NOTE_E7, NOTE_E7, REST, NOTE_E7, REST, NOTE_C7, NOTE_E7, REST, NOTE_G7, REST, REST, REST, NOTE_G6, REST, REST, REST]
        MarionoteDurations = [12, 12, 12, 12, 12, 12, 12, 12, 9, 12, 12, 12, 12, 12, 12, 12]
        # Arduino-Style: ms = 1000 / duration  → sec = 1/duration
        seq = []
        for hz, denom in zip(Mariomelody, MarionoteDurations):
            dur_sec = 1.0 / float(denom)
            seq.append((hz, dur_sec))
        self.publish_notes(seq, append=False)

    def play_indiana_jones(self):
        # Deine Arrays (Indiana Jones) – Dauer bereits in ms
        Jonesnotes = [330, 349, 392, 523, 294, 330, 349, 392, 440, 494, 698, 440, 494, 523, 587, 659,
                      330, 349, 392, 523, 587, 659, 698, 392, 392, 659, 587, 392, 659, 587, 392, 659, 587, 392, 698, 659, 587, 523]
        Jonesdurations = [300, 100, 400, 800, 300, 100, 1200, 300, 100, 400, 800, 300, 100, 400, 400, 400,
                          300, 100, 400, 800, 300, 100, 1200, 300, 100, 400, 300, 100, 400, 300, 100, 400, 300, 100, 400, 300, 100, 1200]
        seq = []
        for hz, ms in zip(Jonesnotes, Jonesdurations):
            seq.append((hz, ms / 1000.0))
        self.publish_notes(seq, append=False)
    ...
    def _undock_result(self, fut):
        ...
        # Nach dem Undock: Mario einmal spielen
        self.play_mario()
    ...
    def step(self):
        ...
        if self.phase == Phase.DRIVE_TILL_HAZARD:
            ...
            # Dock wird über Callbacks weitergeschaltet
